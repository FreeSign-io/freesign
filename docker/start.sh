...
if [ -f "$CERT_PATH" ] && [ -r "$CERT_PATH" ]; then
    ...
    printf "💡 Tip: FreeSign will still start, but document signing will be unavailable\n"
    printf "🔧 Check: http://localhost:3000/api/certificate-status for detailed status\n"
fi

printf "\n📚 Useful Links:\n"
printf "📖 Repository: https://github.com/FreeSign-io/freesign\n"
...
printf "🌟 Starting FreeSign server...\n"
