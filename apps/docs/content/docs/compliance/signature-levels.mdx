...
<Callout type="info">
  FreeSign seals all signed documents cryptographically, regardless of signature level, to prevent
...
<Callout type="warn">
  Status: Planned via third party.
</Callout>
...
## What FreeSign Provides

FreeSign supports Simple Electronic Signatures (SES) with features that enhance evidentiary value:
...
<Callout type="warn">Status: Planned</Callout>
