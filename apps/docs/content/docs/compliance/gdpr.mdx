---
title: GDPR
description: Understand how FreeSign handles GDPR compliance for data processing and storage.
---
...
When using FreeSign for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using FreeSign) determine the purposes and means of processing |
| **Data Processor**  | FreeSign processes personal data on your behalf according to your instructions       |
...
As the data processor, FreeSign:
...
FreeSign processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use FreeSign:

<Tabs items={['FreeSign Cloud', 'Self-Hosted']}>
<Tab value="FreeSign Cloud">
...
Contact FreeSign for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host FreeSign:

- You control all data storage locations
- No data is transmitted to FreeSign's infrastructure
...
- Export user and document data from your FreeSign account
- Delete user accounts and associated documents
- Contact FreeSign support for assistance with cloud-hosted data

## Data Deletion

FreeSign supports data deletion to help fulfill erasure requests:
...
Self-hosting FreeSign can simplify GDPR compliance:
...
- Contact [support@freesign.com](mailto:support@freesign.com) to request a DPA
- The DPA covers FreeSign's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with FreeSign is required since no personal data is processed by FreeSign.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use FreeSign, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy FreeSign on your own infrastructure
