...
Create a service account with the `cloudkms.signerVerifier` role so FreeSign can use the key.

</Step>
<Step>
### Export public certificate

Export the public certificate from the HSM key; FreeSign needs it to embed in signatures.
...
NEXT_PRIVATE_SIGNING_GCLOUD_HSM_KEY_PATH=projects/my-project/locations/global/keyRings/freesign/cryptoKeys/signing-key/cryptoKeyVersions/1
