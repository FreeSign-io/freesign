---
title: Email Domains
description: Learn how to create and manage email domains in FreeSign.
---
...
Email Domains allow you to send emails to recipients from your own domain instead of the default FreeSign email address.
...
- Access to your FreeSign organisation as an admin or manager
...
After adding your domain, FreeSign will provide you with the following required DNS records that need to be configured on your domain:
...
Once you've added the DNS records, return to the FreeSign email domains settings page and click the "Verify" button.
