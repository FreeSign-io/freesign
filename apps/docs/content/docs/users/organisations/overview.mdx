---
title: Overview
description: Organisations are the top-level entity in FreeSign, containing teams, members, and shared settings.
---
...
Organisations are the top-level entity in FreeSign's hierarchy. Each organisation can contain multiple teams, and each team can have multiple members.
...
![Create organisation in FreeSign dashboard](/organisations/organisations-create.webp)
