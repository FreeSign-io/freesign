...
description: Sign up for FreeSign and configure your profile.
---
...
Check your inbox for a verification email and click the confirmation link. The email is sent from `noreply@freesign.com`.
...
<Steps>
  <Step>
    ...
    ![FreeSign account security page showing security options](/get-started-images/documenso-account-security-page.webp)
