...
description: Upload documents to FreeSign to prepare them for signing. Covers supported formats, file size limits, and upload methods.
---
...
<Callout type="warn">
  FreeSign does not support password-protected or encrypted PDF files. Remove encryption before
  uploading.
</Callout>
...
<Steps>
  <Step>
    ...
    Open your [Documents dashboard](https://app.freesign.com/documents).
...
1. **Processing**: FreeSign validates the PDF and extracts page information
