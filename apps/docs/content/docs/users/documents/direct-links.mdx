...
- **Create one automatically**: FreeSign creates a new "Direct Link Recipient" for you
...
```
https://app.freesign.com/d/<unique-token>
```
...
If the recipient has a FreeSign account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public FreeSign profile:
...
![FreeSign profile with direct links](/direct-links/documenso-profile.webp)
...
```html
<a href="https://app.freesign.com/d/your-token">Sign our agreement</a>
```
