---
title: Licenses
description: FreeSign uses a dual licensing model with an open-source AGPL-3.0 license (Community Edition) and a commercial license (Enterprise Edition).
---
...
- Use FreeSign for any purpose, including commercial use
- Access, study, and modify the source code
- Distribute copies of the original or modified software
- Self-host FreeSign on your own infrastructure

### What AGPL-3.0 Requires

The AGPL-3.0 has specific requirements that apply when you modify or distribute FreeSign:

**Source Code Disclosure**: If you modify FreeSign and make it available over a network, you must provide access to the complete source code of your modified version under AGPL-3.0.
...
<Callout type="info">
  ...
  network access as distribution. If users interact with your modified FreeSign instance over a
...
- Use FreeSign internally without modifications
...
The Enterprise Edition provides a commercial license that removes the AGPL-3.0 requirements. This allows organisations to use, modify, and integrate FreeSign without source code disclosure obligations.
...
**Proprietary Integration**: Integrate FreeSign into proprietary products and services without licensing conflicts.
...
- Build commercial products that incorporate FreeSign
...
<Callout type="warn">
  If you modify FreeSign and provide network access to users (internal or external) without
...
<Accordions type="multiple">
  <Accordion title="Do you modify FreeSign?">
    **No modifications**: Both licenses work. Community Edition is free and sufficient if you run FreeSign as-is.
  ...
  <Accordion title="Are you embedding FreeSign in a commercial product?">
  ...
  <Accordion title="Internal use only?">
    Using FreeSign internally without providing network access to external users does not trigger AGPL-3.0 distribution requirements. However, if your organisation has policies against AGPL software or you make modifications you want to keep private, consider the Enterprise Edition.
  </Accordion>
</Accordions>
...
<Accordions type="multiple">
  ...
  <Accordion title="Does using the FreeSign API require a commercial license?">
    No. Calling the FreeSign API from your application does not create a derivative work. Your
    application remains under your chosen license. However, if you modify FreeSign itself and
    provide network access, AGPL-3.0 requirements apply.
  </Accordion>
  <Accordion title='What counts as a "modification" under AGPL-3.0?'>
    Modifying the source code, forking the repository and making changes, or linking FreeSign
    libraries into your application in a way that creates a combined work. Configuration changes and
    using FreeSign through its API are not modifications.
  </Accordion>
  <Accordion title="Can I white-label FreeSign?">
  ...
  <Accordion title="Can I contribute to FreeSign under the Enterprise license?">
    Contributions to the main FreeSign repository are licensed under AGPL-3.0. The Enterprise
...
- [GitHub Repository](https://github.com/FreeSign-io/freesign) - Source code and LICENSE file
