...
Join the FreeSign Discord server to:

- Ask questions and get help from the community
- Share feedback and feature requests
- Connect with other FreeSign users
...
- **[GitHub Discussions](https://github.com/FreeSign-io/freesign/discussions)**: Ask questions, share ideas, and discuss features
- **[GitHub Issues](https://github.com/FreeSign-io/freesign/issues)**: Report confirmed bugs with reproducible steps
...
Paid plans include access to direct support from the FreeSign team.
...
- Email support at support@freesign.com
- Account and billing assistance
- Technical guidance for FreeSign Cloud usage
...
- Private Discord channel for direct communication with the FreeSign team
...
- [GitHub Discussions](https://github.com/FreeSign-io/freesign/discussions) - Community Q&A
...
- Guidance on FreeSign features and functionality
...
For billing disputes or account issues, email support@freesign.com with your account details.
...
FreeSign follows responsible disclosure practices. Security researchers who report valid vulnerabilities responsibly will be acknowledged.

## Contact

| Purpose          | Contact                                                        |
| ---------------- | -------------------------------------------------------------- |
| General support  | support@freesign.com                                          |
| Security issues  | security@freesign.com                                         |
| Enterprise sales | [sales@freesign.com](https://documen.so/enterprise)           |
| Privacy requests | privacy@freesign.com                                          |
| Community        | [Discord](https://documen.so/discord)                          |
| Bug reports      | [GitHub Issues](https://github.com/FreeSign-io/freesign/issues) |
...
- [Privacy Policy](/docs/policies/privacy) - How FreeSign handles your data
