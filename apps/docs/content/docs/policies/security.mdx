---
title: Security
description: Security practices for FreeSign Cloud and self-hosted deployments, along with our vulnerability disclosure process.
---
...
<Accordions type="multiple">
  <Accordion title="Development Security">
    ...
    [github.com/FreeSign-io/freesign](https://github.com/FreeSign-io/freesign)
  </Accordion>
...
<Accordions type="multiple">
  <Accordion title="Encryption in Transit">
    All data transmitted to and from FreeSign is encrypted using TLS 1.2 or higher. This includes:
  ...
  <Accordion title="Application-Level Encryption">
    FreeSign encrypts sensitive data at the application level:
...
FreeSign operates a responsible disclosure process for security vulnerabilities.

<Accordions type="multiple">
  <Accordion title="Reporting a Vulnerability">
    If you discover a security vulnerability, please report it by emailing:

    **security@freesign.com**
...
- [GitHub releases](https://github.com/FreeSign-io/freesign/releases)
- [GitHub security advisories](https://github.com/FreeSign-io/freesign/security/advisories)
...
1. Watch the [GitHub repository](https://github.com/FreeSign-io/freesign) for releases
...
When self-hosting FreeSign, you are responsible for the security of your deployment. The following recommendations apply:
...
- **Security vulnerabilities**: security@freesign.com
- **General questions**: support@freesign.com
- **GitHub**: [github.com/FreeSign-io/freesign](https://github.com/FreeSign-io/freesign)
