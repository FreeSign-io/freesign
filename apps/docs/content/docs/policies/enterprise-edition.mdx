...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organisations to integrate FreeSign into proprietary products.
---
...
- **Build proprietary products**: Integrate FreeSign into commercial software without releasing source code
...
- **Need to keep modifications private**: Any changes to FreeSign source code that you don't want to disclose

<Callout type="info">
  If you run FreeSign without modifications, or your modifications are open source under AGPL-3.0,
...
| SaaS product using FreeSign API only        | Community Edition  |
| SaaS product with modified FreeSign code    | Enterprise Edition |
...
<Accordions type="multiple">
  <Accordion title="License Rights">
    ...
    - **Proprietary integration**: Embed FreeSign in closed-source products without licensing conflicts.
    - **Sublicensing options**: Distribute FreeSign as part of your product to your customers (terms vary by agreement).
  ...
  <Accordion title="License Setup">
    ...
    2. Access your license key at [license.freesign.com](https://license.freesign.com)
    ...
    4. Restart your FreeSign instance
...
<Accordions type="multiple">
  <Accordion title="Grant of License">
    The Enterprise license is a commercial agreement between your organisation and FreeSign. Key terms include:

    - **Scope**: License to use, modify, and distribute FreeSign as specified in your agreement
    - **Exclusions**: The license does not grant rights to FreeSign trademarks beyond what's specified
  ...
  <Accordion title="What the License Does Not Cover">
    ...
    - FreeSign Cloud service (separate subscription)
...
| Factor              | Description                         |
| ------------------- | ----------------------------------- |
| **Deployment type** | Self-hosted or FreeSign Cloud      |
...
<Steps>
  ...
  <Step>
    ...
    - Email: [sales@freesign.com](https://documen.so/enterprise)
  ...
  <Step>
    ...
    Options for evaluating FreeSign before purchase:
  ...
  <Step>
    ...
    3. Deploy using [self-hosting guides](/docs/self-hosting) or access FreeSign Cloud
...
<Accordions type="multiple">
  ...
  <Accordion title="Does the Enterprise license include FreeSign Cloud?">
