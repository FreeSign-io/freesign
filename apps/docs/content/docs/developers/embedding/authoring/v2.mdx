...
| `host`           | `string`  | No       | Custom host URL. Defaults to `https://app.freesign.com` |
...
| `language`       | `string`  | No       | Set the UI language. See [Supported Languages](https://github.com/FreeSign-io/freesign/tree/main/packages/lib/constants/locales.ts) |
