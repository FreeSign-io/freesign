...
FreeSign offers two types of embedding:
...
<Steps>
<Step>
Navigate to your team's templates in FreeSign
...
For example, `https://app.freesign.com/d/-WoSwWVT-fYOERS2MI37k` has the token `-WoSwWVT-fYOERS2MI37k`.
...
| `host`                | `string`   | FreeSign instance URL. Defaults to `https://app.freesign.com`. |
...
| `language`            | `string`   | Set the UI language. See [Supported Languages](https://github.com/FreeSign-io/freesign/tree/main/packages/lib/constants/locales.ts). |
