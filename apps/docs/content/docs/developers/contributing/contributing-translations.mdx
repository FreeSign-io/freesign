...
description: Learn how to contribute translations to FreeSign and become part of our community.
---
...
We store our translations in PO files, which are located in our GitHub repository [here](https://github.com/FreeSign-io/freesign/tree/main/packages/lib/translations).
...
msgid "Want to send slick signing links like this one? <0>Check out FreeSign.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie FreeSign.</0>"
```
...
Thank you for helping make FreeSign more accessible to users around the world!
