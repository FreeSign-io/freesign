---
title: Contributing to FreeSign
description: Learn how to contribute to FreeSign and become part of our community.
---
...
This guide will help you get started with contributing to FreeSign.
...
Search the existing [issues](https://github.com/FreeSign-io/freesign/issues) to see if someone else reported the same issue. Or, check the [existing PRs](https://github.com/FreeSign-io/freesign/pulls) to see if someone else is already working on the same thing.
...
- [Contributing Translations](/docs/developers/contributing/contributing-translations) - Help translate FreeSign
