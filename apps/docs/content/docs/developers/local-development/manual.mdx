---
title: Manual Setup
description: Manually set up FreeSign on your machine for local development.
---
...
Follow these steps to set up FreeSign on your local machine:
...
Fork the [FreeSign repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
Access the FreeSign application by visiting `http://localhost:3000` in your web browser.
