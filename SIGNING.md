...
```
docker run -d --restart=unless-stopped -p 3000:3000 -v freesign:/app/data --name freesign freesign:latest
```
...
- `freesign:latest` - Image you have built
...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/FreeSign-io/freesign)
