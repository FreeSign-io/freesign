    ...
    <>
      ...
      <Section className="flex-row items-center justify-center">
        <Text className="mx-auto mb-0 max-w-[80%] text-center text-lg font-semibold text-primary">
          <Trans>Welcome to FreeSign!</Trans>
        </Text>
        ...
        <Section className="mb-6 mt-8 text-center">
          <Button
            className="inline-flex items-center justify-center rounded-lg bg-freesign-500 px-6 py-3 text-center text-sm font-medium text-black no-underline"
